...
public class OrderService {
    ...
    private ProductDTOWithId mapProduct(Product product){
        return new ProductDTOWithId(product.getId(),product.getName(), product.getQuantity(), product.getMaterial(), product.getCost(), product.getImage(), product.getGender(), product.getClothesType());
    }
}